...
A guided 10-question business diagnostic that scores eight AI Agent roles against a weighted matrix and instantly generates a personalised AI Workforce Fit Report for solopreneurs and SMEs.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238494033+ronwllee-dev@users.noreply.github.com"
  git config user.name "ronwllee-dev"
  ```
